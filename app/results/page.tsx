            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-lg p-4 mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span className="text-slate-600">Concept analyzed by Google Gemini</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-green-100 text-green-800 rounded-full h-5 w-5 flex items-center justify-center mr-2 mt-0.5">
                    ✓
                  </span>
                  <span className="text-slate-600">Features optimized by Anthropic Claude</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-green-100 text-green-800 rounded-full h-5 w-5 flex items-center justify-center mr-2 mt-0.5">
                    ✓
                  </span>
                  <span className="text-slate-600">Build instructions generated by OpenAI GPT</span>
                </li>
              </ul>
            </div>
          </CardContent>
